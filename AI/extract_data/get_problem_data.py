            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": f"Here is a category list.\n{subject2category[subject]}\nPlease predict category from the list and problem number(there is no only 0) from this korean math problem image and output it within a JSON object.\n"
                        }
                    ],
                }
            ],
            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": f"Here is a dictionary:\n{subject2category}\nKeys are math subject and values are categories. Please predict subject, category, problem number(there is no only 0) from image and output it within a JSON object only.\n"
                        }
                    ],
                }
            ],
